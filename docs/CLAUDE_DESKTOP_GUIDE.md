...
This guide walks you through integrating OpenRouter MCP Server with Claude Desktop so you can use OpenRouter models directly inside Claude's interface.
