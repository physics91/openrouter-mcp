...
class TestModelMetadataExtraction:
    ...
    def test_extract_model_capabilities(self):
        ...
        assert capabilities.supports_function_calling  # GPT-4 supports functions
    ...
    def test_enhance_model_metadata_complete(self):
        ...
        assert not enhanced["capabilities"]["supports_vision"]
        assert enhanced["capabilities"]["supports_streaming"]
