...
OPENROUTER_API_KEY_PLACEHOLDER = "REPLACE_WITH_OPENROUTER_API_KEY"
...
def main():
    ...
    print("\n[1] MCP 서버 모듈 테스트...")
    try:
        importlib.import_module("src.openrouter_mcp.server")
    ...
    api_key = os.getenv("OPENROUTER_API_KEY", OPENROUTER_API_KEY_PLACEHOLDER)
    if api_key == OPENROUTER_API_KEY_PLACEHOLDER:
    ...
    if api_key == OPENROUTER_API_KEY_PLACEHOLDER:
        ...
        print(f"   '{OPENROUTER_API_KEY_PLACEHOLDER}'를 실제 API 키로 교체하세요")
