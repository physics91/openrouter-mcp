...
This directory contains benchmarking scripts. Generated results and reports are stored in `.cache/benchmarks/`.
...
├── performance_benchmark_*.py  # Additional benchmark scripts
└── README.md        # This file
```
...
- **JSON files**: Raw benchmark data for programmatic analysis (`.cache/benchmarks/`)
- **CSV files**: Import into spreadsheet applications for analysis (`.cache/benchmarks/`)
- **MD files**: Human-readable reports with formatted tables (`.cache/benchmarks/`)
